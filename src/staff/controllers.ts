...
export default class StaffController extends StaffService {
  public execute = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      } else if (method === 'POST' && routeName === StaffRoutes.FORGOT_PASSWORD) {
  ...
  private getStaffsController = async (type: StaffScope): Promise<IResponse> => {
  ...
  private registerController = async (reqObj: IStaffRegisterObject): Promise<IResponse> => {
  ...
  private loginController = async (reqObj: IStaffLoginRequestObject): Promise<IResponse> => {
  ...
  private changePasswordController = async (reqObj: IStaffPasswordChangeRequestObject): Promise<IResponse> => {
